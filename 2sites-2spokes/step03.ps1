...
$location        = "northeurope"         # location of the Virtual hub
...
#
$rgNameVNet1     = "RG-spokes"           # Resource Group where is deployed the Spoke1 VNet
$rgNameVNet2     = "RG-spokes"           # Resource Group where is deployed the Spoke2 VNet
