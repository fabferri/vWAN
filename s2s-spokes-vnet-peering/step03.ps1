...
$rgName              = "01-vWAN"          # name of the resoure group where is deployed the vWAN
...
$vpnSiteArray = @(
  @{
     rgName_csr         = "01-site1"              # name of the resource group where is deployed the site
   ...
   @{
     rgName_csr         = "01-site2"              # name of the resource group where is deployed the site
     vpnSharedSecret    = "secret!101!"           # shared secred associated with the connection
