...
# - write the configuration of Cisco CSRs in the local script folder
...
#
##################################################################
$subscriptionName   = "AzureDemo3"         #"Windows Azure MSDN - Visual Studio Ultimate"
$rgName             = "01-vWAN"            # name of the resource group where is deployed the storage account
...
$siteArray = @(
  @{
       ...
       priv_externalNetw="10.3.10.0"               ### private network prefix assigned to the external network interface of the Cisco CSR
       mask_externalNetw="255.255.255.0"           ### mask of private network assigned to the external network interface of the Cisco CSR
       priv_externalGateway="10.3.10.1"            ### defautl gateway of the subnet attached to the external interface of Cisco CSR
       priv_internalNetw="10.3.11.0"               ### private network prefix assigned to the internal network interface of the Cisco CSR
  ...
  @{
       ...
       mask_Tunnel1="255.255.255.255"              ### subnet mask tunnel1
       priv_externalNetw="10.3.20.0"               ### private network prefix assigned to the external network interface of the Cisco CSR
       mask_externalNetw="255.255.255.0"           ### mask of private network assigned to the external network interface of the Cisco CSR
       priv_externalGateway="10.3.20.1"            ### defautl gateway of the subnet attached to the external interface of Cisco CSR
       priv_internalNetw="10.3.21.0"               ### private network prefix assigned to the internal network interface of the Cisco CSR
       mask_internalNetw="255.255.255.0"           ### mask of private network assigned to the internal network interface of the Cisco CSR
